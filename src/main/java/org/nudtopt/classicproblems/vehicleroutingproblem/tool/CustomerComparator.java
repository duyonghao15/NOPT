...
import org.nudtopt.classicproblems.vehicleroutingproblem.model.TimeWindow;

public class CustomerComparator extends PriorityComparator {


    @Override
    public int compare(DecisionEntity entity_1, DecisionEntity entity_2) {
        Customer customer_1 = (Customer) entity_1;
        Customer customer_2 = (Customer) entity_2;
        ...
        if(order_1 != null && order_2 != null && order_1.intValue() != order_2.intValue()) {
            return super.compare(entity_1, entity_2);
        }

        TimeWindow timeWindow_1 = customer_1.getTimeWindow();
        TimeWindow timeWindow_2 = customer_2.getTimeWindow();
